...
export const metadata: Metadata = {
  title: "AI Labs — AI Systems That Run Your Operations",
  description:
  ...
  keywords:
    "AI automation, business operations, custom platforms, analytics, Malaysia, 1% Club, AI Labs",
  openGraph: {
    title: "AI Labs — The 1% That Changes Everything",
    description:
      "We solve the problems that hold your business back. AI-powered operations for Malaysian businesses.",
    type: "website",
    url: "https://ailabs.the1percentclub.com",
  },
  twitter: {
